...
export default function TrainerPage() {
  ...
  return (
    <div className="grid gap-4">
      ...
      <label className="grid max-w-xs gap-2 text-sm text-text-subtle">Mode<Select value={mode} onChange={(event) => setMode(event.target.value as "learn" | "review")}><option value="learn">Learn</option><option value="review">Review</option></Select></label>
